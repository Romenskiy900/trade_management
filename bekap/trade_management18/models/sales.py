...
class TradeSales(models.Model):
    ...
    def action_post(self):
        for rec in self:
            ...
            # 🔥 Собираем ID ВАРИАНТОВ (product.product) для склада
            ...
            for line in rec.line_ids:
                # 🔥 Ищем в мапе именно по ID варианта
            ...
            for line in rec.line_ids:
                self.env['stock.move'].create({
                    ...
                    'quantity': line.quantity,  # 🔥 Указываем, сколько списываем
            ...
            # 🔥 Заполняем количество для списания
