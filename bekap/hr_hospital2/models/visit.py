...
class HospitalVisit(models.Model):
    ...
    # def unlink(self):
    #     for rec in self:
    #         if rec.visit_date and rec.visit_date <= fields.Datetime.now():
    #             raise UserError(_("Неможливо видалити візит, який вже відбувся."))
    #     return super().unlink()
    #
    # def write(self, vals):
    ...
    #         for rec in self:
    #             if rec.visit_date and rec.visit_date <= fields.Datetime.now():
    #                 raise UserError(_("Неможливо архівувати візит, який вже відбувся."))
